...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO exercises (lesson_id, question_text, option_one, option_two, option_three, option_four, correct_option) VALUES (?, ?, ?, ?, ?, ?, ?)";

    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param("isssssi", $lesson_id, $question_text, $option_one, $option_two, $option_three, $option_four, $correct_option);
